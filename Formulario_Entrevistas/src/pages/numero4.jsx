...
function Numero4() {
  ...
  const [mostrarHermanosDetalle, setMostrarHermanosDetalle] = useState(saved.hermanos_exalumnos_si_no === "Si" || initialHermanos.length > 0);

  const addHermano = () => {
    setHermanos([...hermanos, { nombre: '', anio: '', taller: '' }]);
  };
  ...
  const handleSubmit = (e, isPrint = false) => {
        ...
        <form onSubmit={handleSubmit} className="p-8 pt-0 space-y-10">
          ...
          <div className="pt-6 border-t border-slate-200">
            ...
            <div className="space-y-8">
              ...
              <div>
                ...
                <div className="flex gap-8 items-center">
                  <label className="flex items-center gap-2 cursor-pointer">
                    <input
                      ...
                      value="Si"
                      checked={mostrarCondicionSaludDetalle}
                      onChange={() => setMostrarCondicionSaludDetalle(true)}
                  ...
                  <label className="flex items-center gap-2 cursor-pointer">
                    <input
                      ...
                      value="No"
                      checked={!mostrarCondicionSaludDetalle}
                      onChange={() => setMostrarCondicionSaludDetalle(false)}
                      className="w-5 h-5 accent-[#4682B4]"
                    />
                ...
                {mostrarCondicionSaludDetalle && (
                  <textarea
                    ...
                    defaultValue={saved.condicion_salud_detalle || ""}
                    placeholder="Explique la condición y tratamiento..."
              ...
              <div>
                <label className="block text-sm font-medium text-slate-700 mb-3">
                  21. ¿Toma su hijo(a) algún medicamento fijo o regularmente?
                </label>
                <div className="flex gap-6 items-center flex-wrap">
                  <label className="flex items-center gap-2 cursor-pointer">
                    <input
                      ...
                      name="medicamento"
                      value="Si"
                      checked={saved.medicamento === "Si"}
                      onChange={() => {
                        setMostrarMedicamentoDetalle(true);
                        setSaved(prev => ({ ...prev, medicamento: "Si" }));
                      }}
                      className="w-5 h-5 accent-[#4682B4]"
                    />
                    <span className="text-sm text-slate-700">Sí</span>
                  ...
                  <label className="flex items-center gap-2 cursor-pointer">
                    <input
                      ...
                      name="medicamento"
                      value="No"
                      checked={saved.medicamento === "No"}
                      onChange={() => {
                        setMostrarMedicamentoDetalle(false);
                        setSaved(prev => ({ ...prev, medicamento: "No" }));
                      }}
                      className="w-5 h-5 accent-[#4682B4]"
                    />
                    <span className="text-sm text-slate-700">No</span>
                  ...
                  <label className="flex items-center gap-2 cursor-pointer">
                    <input
                      ...
                      name="medicamento"
                      value="Tal vez"
                      checked={saved.medicamento === "Tal vez"}
                      onChange={() => {
                        setMostrarMedicamentoDetalle(true);
                        setSaved(prev => ({ ...prev, medicamento: "Tal vez" }));
                      }}
                      className="w-5 h-5 accent-[#4682B4]"
                    />
                ...
                {mostrarMedicamentoDetalle && (
                  <textarea
                    ...
                    defaultValue={saved.medicamento_detalle || ""}
                    placeholder="¿Cuál(es)? Dosis y frecuencia si aplica..."
                    className="mt-4 w-full px-4 py-3 rounded-lg border border-slate-300 outline-none focus:border-[#4682B4] focus:ring-2 focus:ring-blue-100"
                    rows={2}
                  />
                )}
              ...
              <div>
                <label className="block text-sm font-medium text-slate-700 mb-3">
                  22. ¿Quién supervisa al estudiante durante actividades extraescolares?
                </label>
                <div className="flex gap-8 items-center flex-wrap">
                  <label className="flex items-center gap-2 cursor-pointer">
                    <input
                      type="radio"
                      name="supervisor_extraescolar"
                      value="Madre"
                      checked={saved.supervisor_extraescolar === "Madre"}
                      onChange={() => setMostrarOtroSupervisor(false)}
                      className="w-5 h-5 accent-[#4682B4]"
                    />
                  ...
                  <label className="flex items-center gap-2 cursor-pointer">
                    <input
                      ...
                      name="supervisor_extraescolar"
                      value="Padre"
                      checked={saved.supervisor_extraescolar === "Padre"}
                      onChange={() => setMostrarOtroSupervisor(false)}
                      className="w-5 h-5 accent-[#4682B4]"
                    />
                  ...
                  <label className="flex items-center gap-2 cursor-pointer">
                    <input
                      ...
                      name="supervisor_extraescolar"
                      value="Otro"
                      checked={mostrarOtroSupervisor}
                      onChange={() => setMostrarOtroSupervisor(true)}
                      className="w-5 h-5 accent-[#4682B4]"
                    />
                ...
                {mostrarOtroSupervisor && (
                  <div className="mt-4 space-y-4">
                    <div className="flex gap-6 flex-wrap">
                      {["Tutor legal", "Madrastra", "Padrastro"].map(opt => (
                        <label key={opt} className="flex items-center gap-2 cursor-pointer">
                          <input
                            type="radio"
                            name="supervisor_otro"
                            value={opt}
                            defaultChecked={saved.supervisor_otro === opt}
                            className="w-5 h-5 accent-[#4682B4]"
                          />
                    ...
                    <div>
                      ...
                      <input
                        type="text"
                        name="supervisor_otro_especifico"
                        defaultValue={saved.supervisor_otro_especifico || ""}
                        placeholder="Ej: Abuela, tío, hermano mayor..."
              ...
              <div>
                <label className="block text-sm font-medium text-slate-700 mb-3">
                  23. ¿Alguno de los padres reside fuera del país?
                </label>
                <div className="flex gap-8 items-center">
                  <label className="flex items-center gap-2 cursor-pointer">
                    <input
                      ...
                      name="padres_fuera"
                      value="Si"
                      checked={mostrarPadresFueraDetalle}
                      onChange={() => setMostrarPadresFueraDetalle(true)}
                      className="w-5 h-5 accent-[#4682B4]"
                    />
                    <span className="text-sm text-slate-700">Sí</span>
                  </label>
                  <label className="flex items-center gap-2 cursor-pointer">
                    <input
                      ...
                      value="No"
                      checked={!mostrarPadresFueraDetalle}
                      onChange={() => setMostrarPadresFueraDetalle(false)}
                      className="w-5 h-5 accent-[#4682B4]"
                    />
                    <span className="text-sm text-slate-700">No</span>
                  </label>
                  ...
                  <div className="mt-6 space-y-6">
                    <div>
                      ...
                      <div className="flex gap-8 items-center flex-wrap">
                        <label className="flex items-center gap-2 cursor-pointer">
                          <input
                            type="radio"
                            name="padres_fuera_detalle"
                            value="Madre"
                            defaultChecked={saved.padres_fuera_detalle === "Madre"}
                            className="w-5 h-5 accent-[#4682B4]"
                          />
                          <span className="text-sm text-slate-700">Madre</span>
                        </label>
                        <label className="flex items-center gap-2 cursor-pointer">
                          <input
                            ...
                            name="padres_fuera_detalle"
                            value="Padre"
                            defaultChecked={saved.padres_fuera_detalle === "Padre"}
                            className="w-5 h-5 accent-[#4682B4]"
                          />
                          <span className="text-sm text-slate-700">Padre</span>
                        </label>
                        <label className="flex items-center gap-2 cursor-pointer">
                          <input
                            ...
                            name="padres_fuera_detalle"
                            value="Ambos"
                            defaultChecked={saved.padres_fuera_detalle === "Ambos"}
                            className="w-5 h-5 accent-[#4682B4]"
                          />
                    ...
                    <div>
                      ...
                      <div className="relative max-w-md">
                        <span className="absolute left-4 top-1/2 -translate-y-1/2 pointer-events-none text-slate-400 material-symbols-outlined">
                          public
                        </span>
                        <select
                          name="pais_residencia"
                          defaultValue={saved.pais_residencia || ""}
                          className="appearance-none w-full pl-14 pr-14 py-4 rounded-lg border border-slate-300 bg-white text-slate-700 focus:border-[#4682B4] focus:ring-2 focus:ring-blue-100 outline-none cursor-pointer"
                        >
                    ...
                    <div>
                      ...
                      <textarea
                        name="observaciones_padres_fuera"
                        defaultValue={saved.observaciones_padres_fuera || ""}
                        placeholder="Detalles sobre la situación, tiempo fuera, envíos de dinero, visitas, etc..."
                        className="w-full px-4 py-3 rounded-lg border border-slate-300 focus:border-[#4682B4] focus:ring-2 focus:ring-blue-100 outline-none min-h-[100px]"
                        rows={4}
                      />
                    </div>
                  </div>
                  ...
                  {["Propia", "Rentada", "Prestada", "Otros"].map(v => (
                    <label key={v} className="flex items-center gap-2 cursor-pointer">
                      <input
                        ...
                        name="tipo_casa"
                        value={v}
                        checked={saved.tipo_casa === v}
                        onChange={e => setMostrarTipoCasaOtro(e.target.value === "Otros")}
                        className="w-5 h-5 accent-[#4682B4]"
                      />
                ...
                {mostrarTipoCasaOtro && (
                  <div className="mt-4">
                    ...
                    <div className="relative max-w-md">
                      <select
                        name="tipo_casa_otro"
                        defaultValue={saved.tipo_casa_otro || ""}
                        className="appearance-none w-full pl-5 pr-14 py-4 rounded-lg border border-slate-300 bg-white text-slate-700 focus:border-[#4682B4] focus:ring-2 focus:ring-blue-100 outline-none cursor-pointer"
                      >
                  ...
                  {["Ambos viven", "Solo vive la madre", "Solo vive el padre", "Ninguno vive"].map(v => (
                    <label key={v} className="flex items-center gap-2 cursor-pointer">
                      <input
                        ...
                        name="estado_padres"
                        value={v}
                        defaultChecked={saved.estado_padres === v}
                        className="w-5 h-5 accent-[#4682B4]"
                      />
                      <span className="text-sm text-slate-700">{v}</span>
                    </label>
                  ...
                  {["Con ambos", "Solo con la madre", "Solo con el padre", "No convive con ninguno"].map(v => (
                    <label key={v} className="flex items-center gap-2 cursor-pointer">
                      <input
                        ...
                        name="convive_padres"
                        value={v}
                        defaultChecked={saved.convive_padres === v}
                        className="w-5 h-5 accent-[#4682B4]"
                      />
                      <span className="text-sm text-slate-700">{v}</span>
                    </label>
              ...
              {/* 27 - Existe alguna de las siguientes figuras en el núcleo familiar */}
              <div>
                <label className="block text-sm font-medium text-slate-700 mb-3">
                  27. ¿Existe alguna de las siguientes figuras en el núcleo familiar?
                </label>
                <div className="flex gap-6 items-center flex-wrap">
                  {["Madrastra", "Padrastro", "Ambos", "Ninguno"].map(v => (
                    <label key={v} className="flex items-center gap-2 cursor-pointer">
                      <input
                        type="radio"
                        name="figuras_familiares"
                        value={v}
                        defaultChecked={saved.figuras_familiares === v}
                        className="w-5 h-5 accent-[#4682B4]"
                      />
                      <span className="text-sm text-slate-700">{v}</span>
                    </label>
              ...
              <div>
                <label className="block text-sm font-medium text-slate-700 mb-3">
                  28. ¿Tiene algún hermano(a) o exalumno en IPISA?
                </label>
                  ...
                  <div className="space-y-5">
                      ...
                      >
                        <div className="flex justify-between items-center mb-4 pb-3 border-b border-slate-100">
                          <h4 className="text-base font-semibold text-slate-800">
                            Hermano/a o exalumno {index + 1}
                          </h4>
                          {hermanos.length > 1 && (
                            <button
                              type="button"
                              onClick={() => removeHermano(index)}
                              className="flex items-center gap-1.5 text-red-600 hover:text-red-700 hover:bg-red-50 px-3 py-1.5 rounded-md transition-all text-sm font-medium"
                            >
                          ...
                          <div>
                            ...
                            <div className="relative">
                              <select
                                ...
                                defaultValue={h.taller}
                                className="appearance-none w-full px-4 py-3 pr-10 rounded-lg border border-slate-300 bg-white text-slate-700 focus:border-[#4682B4] focus:ring-2 focus:ring-blue-100 outline-none cursor-pointer transition-all"
                              >
                              ...
                              <span className="absolute right-3 top-1/2 -translate-y-1/2 pointer-events-none text-slate-500 material-symbols-outlined">
                                expand_more
                              </span>
                            </div>
                          </div>
                    ...
                    <div className="flex justify-center mt-6">
                      <button
                        type="button"
                        onClick={addHermano}
                        className="px-6 py-2.5 bg-[#4682B4]/10 hover:bg-[#4682B4]/20 text-[#4682B4] rounded-lg border border-[#4682B4]/30 transition-all font-medium flex items-center gap-2 shadow-sm"
                      >
              ...
              <div>
                ...
                <div className="relative max-w-md">
                  <select
                    name="valoracion_familia"
                    defaultValue={saved.valoracion_familia || ""}
                    className="appearance-none w-full pl-5 pr-14 py-4 rounded-lg border border-slate-300 bg-white text-slate-700 focus:border-[#4682B4] focus:ring-2 focus:ring-blue-100 outline-none cursor-pointer"
                  >
                ...
                <p className="mt-2 text-xs text-slate-500">
                  El 100 se le da prioridad y el 25 menos prioridad
                </p>
              </div>
          ...
          <div className="mt-12 pt-8 border-t border-slate-200 flex flex-col sm:flex-row items-center justify-between gap-4">
            ...
            <div className="flex gap-4 w-full sm:w-auto order-1 sm:order-2">
              ...
              <button
                type="button"
                onClick={handlePrint}
                className="flex-1 sm:flex-none px-8 py-3 rounded-xl border border-[#4682B4] text-[#4682B4] font-medium hover:bg-blue-50 transition-all flex items-center justify-center gap-2"
              >
        ...
        <div className="fixed inset-0 flex items-center justify-center bg-slate-900/70 backdrop-blur-sm z-50">
          <div className="bg-white p-7 rounded-2xl shadow-2xl max-w-sm w-full text-center border border-slate-200">
            ...
            <button 
              ...
              className="bg-[#4682B4] text-white px-8 py-3 rounded-xl font-medium hover:opacity-90 transition-all"
            >
              OK
            </button>
          </div>
          ...
          <div className="bg-white p-7 rounded-2xl shadow-2xl max-w-sm w-full text-center border border-slate-200">
            ...
            <div className="flex justify-center gap-5">
              ...
              <button 
                ...
                className="border border-slate-300 text-slate-700 px-8 py-3 rounded-xl font-medium hover:bg-slate-50 transition-all"
              >
                No
              </button>
            </div>
